...
* **Оценка привлекательности сегментов (Ad hoc 1):** Определение наиболее ликвидных и востребованных типов недвижимости в Санкт-Петербурге и городах области на основе времени активности объявлений (скорости продажи).
