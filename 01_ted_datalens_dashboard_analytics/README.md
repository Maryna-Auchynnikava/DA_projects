...
### 📌 Описание проекта
Данный проект разработан для компании, которая приобрела лицензию на проведение конференций TED. На этапе организации первого мероприятия заказчику требовался аналитический инструмент для подбора спикеров, тем и площадок. Дашборд помогает принимать решения на основе исторических данных прошлых конференций TED.
